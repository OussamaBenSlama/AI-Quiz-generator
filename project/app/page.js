    ...
    <>
      <div className='flex flex-wrap justify-center items-center'>
        <div className='md:w-1/2 w-full md:h-[90vh] flex justify-center items-center'>
          <img src='/Upload-rafiki.png' className='md:max-w-[400px]' style={{ maxHeight: '70vh', filter: 'hue-rotate(150deg)' }} />
        </div>
        <div className="md:w-1/2 w-full">
          <form className='md:max-w-[450px] bg-white p-6 rounded-lg mx-4 my-6' style={{ boxShadow: "rgba(0, 0, 0, 0.2) 0px 1px 2px" }} onSubmit={handleSubmit} >
